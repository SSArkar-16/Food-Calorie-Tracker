class Result {
	...
	getStatus() {
		const status = [
			"Your body is too thin, try to eat nutritious food, okay? :)",
			"Your body is normal, keep your health so you don't get sick :)",
			"Your body is unfit, try to reduce fatty foods :)",
			"You are obese, try to do a diet regularly :)"
		];
