...
function setManualRecognition(data) {
							...
							<div class="col-8 col-md-7 p-0">
								<div class="row m-0 p-0 justify-content-end">
									<div class="col-12 col-md-12 p-0">
										<input class="form-control py-2 bordered mb-2" type="text" placeholder="Enter Name" name="food-name">
										<textarea class="form-control py-2 bordered mb-2" type="text" placeholder="Composition\nExample: 1 tbsp sugar, 1 tsp salt, 1 plate of rice (separated by comma)" name="food-composition" rows="5"></textarea>
	...
	$(".btn-calculate").click(function() {
		...
		$(".subtitle").text('Counting nutrition....');
		$.ajax({
			type: 'get',
